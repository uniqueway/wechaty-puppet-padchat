...
function fileBoxToQrcode(file) {
    return __awaiter(this, void 0, void 0, function () {
        var image, _a, _b, qrCodeImageArray, qrCodeResult;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    image = _c.sent();
                    qrCodeImageArray = new Uint8ClampedArray(image.bitmap.data.buffer);
                    qrCodeResult = jsqr_1["default"](qrCodeImageArray, image.bitmap.width, image.bitmap.height);
                    if (qrCodeResult) {
                        return [2 /*return*/, qrCodeResult.data];
                    }
                    else {
...
exports.fileBoxToQrcode = fileBoxToQrcode;
